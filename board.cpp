...
void Board::initComponents(){
    ...
    places.push_back(new CommunityChest(430, 527, 0, 0, "Community Chest", 50, 80));

	places.push_back(new NormalProperty(380, 527, 4, 60, "Baltic Avenue", 50, 80));
    sf::Texture t3;
	...
	//Celestes
	places.push_back(new NormalProperty(232, 527, 6, 100, "Oriental Avenue", 50, 80));
    sf::Texture t6;
    t6.loadFromFile("./resources/propiedades/celestes/Oriental_Ave.png");
    places[6]->setImage(t6);
    sprites.push_back(places[6]->getSprite());

    places.push_back(new Chance(183, 527, 0, 0, "Chance", 50, 80));

	places.push_back(new NormalProperty(134, 527, 6, 100, "Vermont Avenue", 50, 80));
    sf::Texture t8;
    t8.loadFromFile("./resources/propiedades/celestes/Vermont_ave.png");
    places[8]->setImage(t8);
    sprites.push_back(places[8]->getSprite());

	places.push_back(new NormalProperty(85, 527, 8, 120, "Connecticut Avenue", 50, 80));
    sf::Texture t9;
    ...
    places.push_back(new RR(6, 280, 25, 200, "Pennsylvania Railroad", 80, 50));
    sf::Texture t15;
	...
	//Anaranjadas
	places.push_back(new NormalProperty(6, 232, 14, 180, "St James Place", 80, 50));
    sf::Texture t16;
    ...
    places.push_back(new CommunityChest(6, 184, 0, 0, "Community Chest", 80, 50));

	places.push_back(new NormalProperty(6, 134, 14, 160, "Tennessee Avenue", 80, 50));
    sf::Texture t18;
	...
	places.push_back(new NormalProperty(6, 85, 16, 200, "New York Avenue", 80, 50));
    sf::Texture t19;
    ...
    places.push_back(new Chance(134, 6, 0, 0, "Chance", 50, 80));

	places.push_back(new NormalProperty(183, 6, 18, 220, "Indiana Avenue", 50, 80));
    sf::Texture t23;
    t23.loadFromFile("./resources/propiedades/rojas/Indiana_ave.png");
    places[23]->setImage(t23);
    sprites.push_back(places[23]->getSprite());

	places.push_back(new NormalProperty(232, 6, 20, 240, "Illinois Avenue", 50, 80));
    sf::Texture t24;
    t24.loadFromFile("./resources/propiedades/rojas/Illinois_ave.png");
    places[24]->setImage(t24);
    sprites.push_back(places[24]->getSprite());

    places.push_back(new RR(282, 6, 25, 200, "B & O Railroad", 50, 80));
    sf::Texture t25;
	...
	//Amarillo
	places.push_back(new NormalProperty(330, 6, 22, 260, "Atlantic Avenue", 50, 80));
    sf::Texture t26;
	...
	places.push_back(new NormalProperty(380, 6, 22, 260, "Ventnor Avenue", 50, 80));
    sf::Texture t27;
    ...
    places.push_back(new Utilities(430, 6, 75, 150, "Water Works", 50, 80));
    sf::Texture t28;
    t28.loadFromFile("./resources/utilities/utilities1.png");
    places[28]->setImage(t28);
    sprites.push_back(places[28]->getSprite());

	places.push_back(new NormalProperty(478, 6, 24, 280, "Marvin Gardens", 50, 80));
    sf::Texture t29;
	...
	places.push_back(new NormalProperty(527, 134, 26, 300, "North Carolina Avenue", 80, 50));
    sf::Texture t32;
    ...
    places.push_back(new CommunityChest(527, 184, 0, 0, "Community Chest", 80, 50));

	places.push_back(new NormalProperty(527, 232, 28, 320, "Pennsylvania Avenue", 80, 50));
    sf::Texture t34;
    ...
    places.push_back(new RR(527, 282, 25, 200, "Short Line Railroad", 80, 50));
    sf::Texture t35;
    t35.loadFromFile("./resources/railroad/railroad2.png");
    places[35]->setImage(t35);
    sprites.push_back(places[35]->getSprite());

    places.push_back(new Chance(527, 332, 0, 0, "Chance", 80, 50));

	//Azul
	places.push_back(new NormalProperty(527, 380, 35, 360, "Park Place", 80, 50));
    sf::Texture t37;
